...
public final class Config {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> GROUP_IDS = BUILDER
                        .comment(
                        ...
                        .defineListAllowEmpty(
                                        List.of("groupIds"),
                                        () -> Objects.requireNonNull(List.<String>of()),
        ...
        public static List<String> groupIds() {
                List<? extends String> configured = GROUP_IDS.get();
